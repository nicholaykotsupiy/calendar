...
export default {
    ...
    methods: {
        ...
        newPassword() {
            axios.post('http://it20auth.pp.ua/api/login/repair-password/code', {
                'code': this.code,
        ...
        resendCode() {
            axios.post('http://it20auth.pp.ua/api/login/resend-code', {
        ...
        secretCode() {
            ...
            axios.post('http://it20auth.pp.ua/api/login/check-secret', payload).then(() => {
    ...
    created() {
        axios.post('http://it20auth.pp.ua/api/login/check-reserved-email', {
            email: this.resetPasswordEmail
        }).then((response) => {
