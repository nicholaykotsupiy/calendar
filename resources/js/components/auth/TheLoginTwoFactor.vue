...
export default {
    ...
    methods: {
        ...
        login() {
            ...
            axios.post('http://it20auth.pp.ua/api/login/reserved-password', payload).then((response) => {
                this.hasError = false;
        ...
        getEmailCode() {
            ...
            axios.post('http://it20auth.pp.ua/api/login/get-code', payload).then((response) => {
                this.hasError = false;
