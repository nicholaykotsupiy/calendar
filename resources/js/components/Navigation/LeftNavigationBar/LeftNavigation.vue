<template>
    <ul class="col-2 col-sm-1 h-auto nav-list">
        ...
        <li class="list-item d-flex flex-column align-items-center py-2">
            <svg width="33" height="30" viewBox="0 0 33 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="mask2" mask-type="alpha" maskUnits="userSpaceOnUse" x="5" y="7" width="23" height="16">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M25.15 7H7.85C6.66063 7 5.69831 7.9 5.69831 9L5.6875 21C5.6875 22.1 6.66063 23 7.85 23H25.15C26.3394 23 27.3125 22.1 27.3125 21V9C27.3125 7.9 26.3394 7 25.15 7ZM25.15 11L16.5 16L7.85001 11V9L16.5 14L25.15 9V11Z" fill="white"/>
                </mask>
                <g mask="url(#mask2)">
                    <rect x="2.44336" y="2" width="28.1125" height="26" fill="#D8D8D8"/>
                </g>
        ...
        <li class="list-item d-flex flex-column align-items-center py-2">
            <svg width="33" height="30" viewBox="0 0 33 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g mask="url(#mask3)">
                    <rect x="2.3623" y="2" width="28.1125" height="26" fill="#1875F0"/>
                </g>
            </svg>
            <div class="title d-none d-lg-block">
                Календарь
        ...
        <li class="list-item d-flex flex-column align-items-center py-2">
            <svg width="33" height="30" viewBox="0 0 33 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="mask6" mask-type="alpha" maskUnits="userSpaceOnUse" x="5" y="6" width="23" height="18">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.3375 19V18H6.77956L6.76875 22C6.76875 23.11 7.73106 24 8.93125 24H24.0688C25.2689 24 26.2313 23.11 26.2313 22V18H18.6625V19H14.3375ZM25.15 10H20.8142V8L18.6517 6H14.3267L12.1642 8V10H7.85C6.66063 10 5.6875 10.9 5.6875 12V15C5.6875 16.11 6.64981 17 7.85 17H14.3375V15H18.6625V17H25.15C26.3394 17 27.3125 16.1 27.3125 15V12C27.3125 10.9 26.3394 10 25.15 10ZM18.6625 10H14.3375V8H18.6625V10Z" fill="white"/>
                </mask>
                <g mask="url(#mask6)">
                    <rect x="2.44336" y="2" width="28.1125" height="26" fill="#D8D8D8"/>
                </g>
